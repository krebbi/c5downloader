 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","http://www.concrete5.org/download_file/-/view/113632/");
define("VERSION","Ver.5-8.5.4");
define("FILENAME","./concrete5-8.5.4.zip");
define("DIRNAME","./concrete5-8.5.4");
