 ...
 * その代わり当方では一切責任を負いません。
 */
define("SRC_URL","http://www.concrete5.org/download_file/-/view/108181/");
define("VERSION","Ver.5-8.4.4");
define("FILENAME","./concrete5-8.4.4.zip");
define("DIRNAME","./concrete5-8.4.4");
...
<footer>copyright &copy; <?php echo date("Y");?> <a target="_blank" href="http://www.xross-cube.com/">XROSS CUBE, Inc.</a> All Rights Reserved.<br>
Modified version by <a target="_blank" href="https://datatainment.de">datatainment</a></footer>
